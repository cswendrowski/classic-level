...
// TODO (v2)
false && test('test argument-less getProperty() throws', function (t) {
...
// TODO (v2)
false && test('test non-string getProperty() throws', function (t) {
  t.throws(db.getProperty.bind(db, {}), {
    name: 'TypeError',
    message: "The first argument 'property' must be a string"
  })
...
// TODO (v2)
false && test('test invalid getProperty() returns empty string', function (t) {
...
// TODO (v2)
false && test('test invalid getProperty("leveldb.num-files-at-levelN") returns numbers', function (t) {
  for (let i = 0; i < 7; i++) {
...
// TODO (v2)
false && test('test invalid getProperty("leveldb.stats")', function (t) {
  t.ok(db.getProperty('leveldb.stats').split('\n').length > 3, 'leveldb.stats has > 3 newlines')
  t.end()
})

// TODO (v2)
false && test('test invalid getProperty("leveldb.sstables")', function (t) {
...
// TODO (v2)
false && test('getProperty() throws if db is closed', function (t) {
